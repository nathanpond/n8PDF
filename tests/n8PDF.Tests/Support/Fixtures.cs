...
public static class Fixtures
{
    ...
    /// <summary>
    /// A three-dimensional chart for the depth-axis story: three series under a stated grouping,
    /// one bar pickable in red, and the series axis deletable or not.
    /// </summary>
    private static string ChartPart3DDepthAxis(string grouping, int red, bool serAxDrawn,
        int categories = 1, int seriesCount = 3)
    {
        var cats = string.Concat(Enumerable.Range(0, categories)
            .Select(i => $"""<c:pt idx="{i}"><c:v>K{i}</c:v></c:pt>"""));
        var series = string.Concat(Enumerable.Range(0, seriesCount).Select(j => $$"""
            <c:ser><c:idx val="{{j}}"/><c:order val="{{j}}"/>
              <c:tx><c:strRef><c:f>Sheet1!${{(char)('B' + j)}}$1</c:f><c:strCache><c:ptCount val="1"/>
                <c:pt idx="0"><c:v>S{{j}}</c:v></c:pt></c:strCache></c:strRef></c:tx>
              <c:spPr><a:solidFill><a:srgbClr val="{{(red < 0 || red == j ? "FF0000" : "BFBFBF")}}"/></a:solidFill>
                <a:ln><a:noFill/></a:ln></c:spPr>
              ...
              <c:val><c:numRef><c:f>Sheet1!${{(char)('B' + j)}}$2:${{(char)('B' + j)}}${{categories + 1}}</c:f><c:numCache>
                ...
                {{string.Concat(Enumerable.Range(0, categories).Select(i =>
                    $"""<c:pt idx="{i}"><c:v>{(grouping == "stacked" ? 30 : 60)}</c:v></c:pt>"""))}}</c:numCache></c:numRef></c:val>
            </c:ser>
            """));

        return $$"""
          <c:chart>
            <c:view3D><c:rotX val="15"/><c:rotY val="20"/><c:rAngAx val="1"/>
              <c:perspective val="30"/><c:depthPercent val="100"/></c:view3D>
            <c:plotArea>
              <c:layout><c:manualLayout><c:layoutTarget val="inner"/>
                <c:xMode val="edge"/><c:yMode val="edge"/>
              ...
              <c:bar3DChart>
                <c:barDir val="col"/><c:grouping val="{{grouping}}"/><c:varyColors val="0"/>
                {{series}}
                <c:gapWidth val="150"/><c:gapDepth val="150"/><c:shape val="box"/>
                <c:axId val="111111111"/><c:axId val="222222222"/><c:axId val="333333333"/>
              </c:bar3DChart>
              ...
              <c:serAx><c:axId val="333333333"/>
                <c:scaling><c:orientation val="minMax"/></c:scaling>
                <c:delete val="{{(serAxDrawn ? 0 : 1)}}"/><c:axPos val="b"/>
                <c:tickLblPos val="{{(serAxDrawn ? "nextTo" : "none")}}"/>{{(
                  serAxDrawn ? "<c:majorTickMark val=\"out\"/>" : "")}}
                <c:crossAx val="222222222"/></c:serAx>
            </c:plotArea>
            <c:plotVisOnly val="1"/>
          </c:chart>
    ...
    /// <summary>
    /// A three-dimensional chart for the box-drawing story: series in stated colours and values,
    /// under a stated grouping, direction, turn and arm — so that draw order, negatives and the
    /// lying direction can each be read off a page.
    /// </summary>
    private static string ChartPart3DBox(
        string grouping, string barDir, int rotY, int rightAngled,
        (string Colour, double[] Values)[] series, int min = 0, int max = 100)
    {
        ...
        return $$"""
          <c:chart>
            <c:view3D><c:rotX val="15"/><c:rotY val="{{rotY}}"/><c:rAngAx val="{{rightAngled}}"/>
              <c:perspective val="30"/><c:depthPercent val="100"/></c:view3D>
            <c:plotArea>
              <c:layout><c:manualLayout><c:layoutTarget val="inner"/>
                <c:xMode val="edge"/><c:yMode val="edge"/>
    ...
    /// <summary>The scene a pie page states, with only the knobs a pie honours.</summary>
    private static string Pie3DView(int rotX, int perspective = 30, int hPercent = 0) =>
        $"""
        <c:view3D><c:rotX val="{rotX}"/><c:rotY val="20"/><c:rAngAx val="0"/>
          <c:perspective val="{perspective}"/><c:depthPercent val="100"/>{(
            hPercent > 0 ? $"<c:hPercent val=\"{hPercent}\"/>" : "")}</c:view3D>
        """;

    /// <summary>
    /// A three-dimensional pie for the sector-and-rim story: three unequal slices in colours the
              ...
              <c:pie3DChart>
                ...
                <c:ser><c:idx val="0"/><c:order val="0"/>
                  ...
                  <c:cat><c:strRef><c:f>Sheet1!$A$2:$A$4</c:f><c:strCache><c:ptCount val="3"/>
                    ...
                    <c:pt idx="2"><c:v>C</c:v></c:pt></c:strCache></c:strRef></c:cat>
                  <c:val><c:numRef><c:f>Sheet1!$B$2:$B$4</c:f><c:numCache>
                    <c:formatCode>General</c:formatCode><c:ptCount val="3"/>
                    <c:pt idx="0"><c:v>50</c:v></c:pt><c:pt idx="1"><c:v>30</c:v></c:pt>
                    <c:pt idx="2"><c:v>20</c:v></c:pt></c:numCache></c:numRef></c:val>
                </c:ser>
                <c:firstSliceAng val="{{firstSlice}}"/>
              </c:pie3DChart>
            </c:plotArea>
            <c:plotVisOnly val="1"/>
          </c:chart>
    ...
    public static IReadOnlyDictionary<string, Func<DocxBuilder>> All { get; } =
        new Dictionary<string, Func<DocxBuilder>>(StringComparer.Ordinal)
        {
            ...
            ["chart-3d-projection-probe"] = () => new DocxBuilder()
                .WithChart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 15, 20))
                .WithPart("word/charts/chart2.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 25, 20)),
                    fromDocument: ("rIdChart2",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart3.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 35, 20)),
                    fromDocument: ("rIdChart3",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart4.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 55, 20)),
                    fromDocument: ("rIdChart4",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart5.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 20, 15)),
                    fromDocument: ("rIdChart5",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart6.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 20, 30)),
                    fromDocument: ("rIdChart6",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart7.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 20, 45)),
                    fromDocument: ("rIdChart7",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart8.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 60, 15, 20)),
                    fromDocument: ("rIdChart8",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart9.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 130, 15, 20)),
                    fromDocument: ("rIdChart9",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart10.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 250, 15, 20)),
                    fromDocument: ("rIdChart10",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart11.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(2, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 15, 20)),
                    fromDocument: ("rIdChart11",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart12.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 2, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 15, 20)),
                    fromDocument: ("rIdChart12",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart13.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 130, 32, 48)),
                    fromDocument: ("rIdChart13",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart14.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 70, 22, 12)),
                    fromDocument: ("rIdChart14",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart15.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 2, 0.2, 0.1, 0.6, 0.55, 1, 60, 160, 28, 40)),
                    fromDocument: ("rIdChart15",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart16.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 100, 100, 15, 20)),
                    fromDocument: ("rIdChart16",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart17.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 100, 100, 30, 20)),
                    fromDocument: ("rIdChart17",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart18.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 30, 100, 15, 20)),
                    fromDocument: ("rIdChart18",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart19.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 90, 100, 15, 20)),
                    fromDocument: ("rIdChart19",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart20.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 100, 100, 20, 45)),
                    fromDocument: ("rIdChart20",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart21.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 15, 20, 30, 150)),
                    fromDocument: ("rIdChart21",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart22.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 1, 60, 100, 15, 20, 30, 50)),
                    fromDocument: ("rIdChart22",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1600, relationshipId: "rIdChart") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1601, relationshipId: "rIdChart2") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>25/20 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1602, relationshipId: "rIdChart3") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>35/20 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1603, relationshipId: "rIdChart4") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>55/20 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1604, relationshipId: "rIdChart5") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>20/15 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1605, relationshipId: "rIdChart6") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>20/30 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1606, relationshipId: "rIdChart7") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>20/45 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1607, relationshipId: "rIdChart8") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 d60</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1608, relationshipId: "rIdChart9") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 d130</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1609, relationshipId: "rIdChart10") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 d250</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1610, relationshipId: "rIdChart11") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>2c1s 15/20 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1611, relationshipId: "rIdChart12") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>1c2s 15/20 d100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1612, relationshipId: "rIdChart13") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>held 32/48 d130</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1613, relationshipId: "rIdChart14") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>held 22/12 d70</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1614, relationshipId: "rIdChart15") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>held 1c2s 28/40 d160</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1615, relationshipId: "rIdChart16") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>v100 15/20</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1616, relationshipId: "rIdChart17") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>v100 30/20</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1617, relationshipId: "rIdChart18") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>v30 15/20</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1618, relationshipId: "rIdChart19") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>v90 15/20</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1619, relationshipId: "rIdChart20") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>v100 20/45</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1620, relationshipId: "rIdChart21") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>h150 15/20</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1621, relationshipId: "rIdChart22") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
            ...
            ["chart-3d-depth-axis-probe"] = () => new DocxBuilder()
                .WithChart(ChartPart3DDepthAxis("stacked", -1, false))
                .WithPart("word/charts/chart2.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DDepthAxis("clustered", -1, false)),
                    fromDocument: ("rIdChart2",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart3.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                ...
                .WithPart("word/charts/chart4.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DDepthAxis("standard", -1, true)),
                    fromDocument: ("rIdChart4",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart5.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DDepthAxis("clustered", -1, false, 2, 3)),
                    fromDocument: ("rIdChart5",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart6.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DDepthAxis("clustered", -1, false, 1, 2)),
                    fromDocument: ("rIdChart6",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1800, relationshipId: "rIdChart") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>stacked union</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1801, relationshipId: "rIdChart2") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>clustered union</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1802, relationshipId: "rIdChart3") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>clustered mid red</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1803, relationshipId: "rIdChart4") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>serAx drawn</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1804, relationshipId: "rIdChart5") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>clustered 2c3s union</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1805, relationshipId: "rIdChart6") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>clustered 1c2s union</w:t></w:r></w:p>"),

            ["chart-3d-box-probe"] = () => new DocxBuilder()
                .WithChart(ChartPart3DBox("standard", "col", 20, 1, [("FF0000", [30.0, 60.0]), ("0000FF", [90.0, 45.0])]))
                .WithPart("word/charts/chart2.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("standard", "col", 340, 1, [("FF0000", [30.0, 60.0]), ("0000FF", [90.0, 45.0])])),
                    fromDocument: ("rIdChart2",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart3.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("standard", "col", 110, 1, [("FF0000", [30.0, 60.0]), ("0000FF", [90.0, 45.0])])),
                    fromDocument: ("rIdChart3",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart4.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("clustered", "col", 20, 1, [("FF0000", [60.0]), ("0000FF", [80.0]), ("00C000", [40.0])])),
                    fromDocument: ("rIdChart4",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart5.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("stacked", "col", 20, 1, [("FF0000", [30.0]), ("0000FF", [30.0]), ("00C000", [30.0])])),
                    fromDocument: ("rIdChart5",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart6.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("standard", "col", 20, 1, [("FF0000", [-60.0])], -100, 100)),
                    fromDocument: ("rIdChart6",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart7.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("standard", "bar", 20, 1, [("FF0000", [60.0])])),
                    fromDocument: ("rIdChart7",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart8.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("standard", "col", 20, 0, [("FF0000", [30.0, 60.0]), ("0000FF", [90.0, 45.0])])),
                    fromDocument: ("rIdChart8",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart9.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DBox("standard", "bar", 20, 1, [("FF0000", [30.0, 60.0]), ("0000FF", [90.0, 45.0])])),
                    fromDocument: ("rIdChart9",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1900, relationshipId: "rIdChart") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>order 20</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1901, relationshipId: "rIdChart2") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>order 340</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1902, relationshipId: "rIdChart3") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>order 110</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1903, relationshipId: "rIdChart4") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>cluster order</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1904, relationshipId: "rIdChart5") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>stack order</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1905, relationshipId: "rIdChart6") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>negative</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1906, relationshipId: "rIdChart7") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>lying</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1907, relationshipId: "rIdChart8") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>order camera</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 1908, relationshipId: "rIdChart9") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>lying order</w:t></w:r></w:p>"),

            ["chart-3d-pie-probe"] = () => new DocxBuilder()
                .WithChart(ChartPart3DPie(""))
                .WithPart("word/charts/chart2.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(10, 30, 100))),
                    fromDocument: ("rIdChart2",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart3.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(25, 30, 100))),
                    fromDocument: ("rIdChart3",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart4.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(40, 30, 100))),
                    fromDocument: ("rIdChart4",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart5.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 30, 100), 45)),
                    fromDocument: ("rIdChart5",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart6.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 30, 100), 135)),
                    fromDocument: ("rIdChart6",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart7.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 30, 100), 225)),
                    fromDocument: ("rIdChart7",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart8.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 30, 100), 315)),
                    fromDocument: ("rIdChart8",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart9.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 30, 100), 0, 25)),
                    fromDocument: ("rIdChart9",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart10.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 30, 100))),
                    fromDocument: ("rIdChart10",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart11.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 60, 100))),
                    fromDocument: ("rIdChart11",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart12.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(10, 0))),
                    fromDocument: ("rIdChart12",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart13.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 0))),
                    fromDocument: ("rIdChart13",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart14.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(25, 0))),
                    fromDocument: ("rIdChart14",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart15.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(40, 0))),
                    fromDocument: ("rIdChart15",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart16.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 15))),
                    fromDocument: ("rIdChart16",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart17.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(25, 15))),
                    fromDocument: ("rIdChart17",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart18.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DPie(Pie3DView(15, 45))),
                    fromDocument: ("rIdChart18",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart19.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                ...
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 ...
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>absent scene</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2001, relationshipId: "rIdChart2") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>rotX 10</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2002, relationshipId: "rIdChart3") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>rotX 25</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2003, relationshipId: "rIdChart4") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>rotX 40</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2004, relationshipId: "rIdChart5") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>turn 45</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2005, relationshipId: "rIdChart6") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>turn 135</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2006, relationshipId: "rIdChart7") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>turn 225</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2007, relationshipId: "rIdChart8") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>turn 315</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2008, relationshipId: "rIdChart9") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>explosion 25</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2009, relationshipId: "rIdChart10") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>hPercent 150</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2010, relationshipId: "rIdChart11") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>perspective 60</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2011, relationshipId: "rIdChart12") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>p0 rotX 10</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2012, relationshipId: "rIdChart13") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>p0 rotX 15</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2013, relationshipId: "rIdChart14") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>p0 rotX 25</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2014, relationshipId: "rIdChart15") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>p0 rotX 40</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2015, relationshipId: "rIdChart16") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>p15 rotX 15</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2016, relationshipId: "rIdChart17") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>p15 rotX 25</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2017, relationshipId: "rIdChart18") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>p45 rotX 15</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
...
,
            ...
            ["chart-3d-deep-probe"] = () => new DocxBuilder()
                ...
                .WithPart("word/charts/chart2.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 150, 0)),
                    fromDocument: ("rIdChart2",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart3.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 190, 0)),
                    fromDocument: ("rIdChart3",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart4.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 20, 90, 0)),
                    fromDocument: ("rIdChart4",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart5.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 20, 140, 0)),
                    fromDocument: ("rIdChart5",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart6.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 20, 160, 0)),
                    fromDocument: ("rIdChart6",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart7.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 20, 180, 0)),
                    fromDocument: ("rIdChart7",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart8.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 20, 220, 0)),
                    fromDocument: ("rIdChart8",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart9.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 20, 240, 0)),
                    fromDocument: ("rIdChart9",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart10.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 45, 20, 140, 0)),
                    fromDocument: ("rIdChart10",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart11.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 45, 20, 180, 0)),
                    fromDocument: ("rIdChart11",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart12.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 45, 20, 220, 0)),
                    fromDocument: ("rIdChart12",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart13.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 45, 20, 200, 0)),
                    fromDocument: ("rIdChart13",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart14.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 22, 20, 100, 0)),
                    fromDocument: ("rIdChart14",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart15.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 22, 20, 140, 0)),
                    fromDocument: ("rIdChart15",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart16.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 22, 20, 160, 0)),
                    fromDocument: ("rIdChart16",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart17.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 22, 20, 180, 0)),
                    fromDocument: ("rIdChart17",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart18.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 22, 20, 240, 0)),
                    fromDocument: ("rIdChart18",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart19.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 38, 20, 100, 0)),
                    fromDocument: ("rIdChart19",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart20.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 38, 20, 120, 0)),
                    fromDocument: ("rIdChart20",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart21.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 38, 20, 160, 0)),
                    fromDocument: ("rIdChart21",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart22.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 38, 20, 180, 0)),
                    fromDocument: ("rIdChart22",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart23.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 38, 20, 200, 0)),
                    fromDocument: ("rIdChart23",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart24.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 38, 20, 240, 0)),
                    fromDocument: ("rIdChart24",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart25.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 35, 100, 0)),
                    fromDocument: ("rIdChart25",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart26.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 35, 140, 0)),
                    fromDocument: ("rIdChart26",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart27.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 35, 160, 0)),
                    fromDocument: ("rIdChart27",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart28.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 35, 180, 0)),
                    fromDocument: ("rIdChart28",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart29.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 35, 240, 0)),
                    fromDocument: ("rIdChart29",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart30.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 50, 120, 0)),
                    fromDocument: ("rIdChart30",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart31.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 50, 140, 0)),
                    fromDocument: ("rIdChart31",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart32.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 50, 180, 0)),
                    fromDocument: ("rIdChart32",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart33.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 50, 240, 0)),
                    fromDocument: ("rIdChart33",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart34.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 60, 15, 120, 0)),
                    fromDocument: ("rIdChart34",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart35.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 60, 15, 160, 0)),
                    fromDocument: ("rIdChart35",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart36.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 60, 15, 200, 0)),
                    fromDocument: ("rIdChart36",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart37.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 60, 15, 240, 0)),
                    fromDocument: ("rIdChart37",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart38.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 45, 45, 160, 0)),
                    fromDocument: ("rIdChart38",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart39.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 45, 45, 200, 0)),
                    fromDocument: ("rIdChart39",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart40.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 45, 45, 240, 0)),
                    fromDocument: ("rIdChart40",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart41.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 50, 30, 20, 160, 0)),
                    fromDocument: ("rIdChart41",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart42.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 150, 30, 20, 160, 0)),
                    fromDocument: ("rIdChart42",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart43.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 200, 30, 20, 160, 0)),
                    fromDocument: ("rIdChart43",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart44.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 160, 50)),
                    fromDocument: ("rIdChart44",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart45.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 160, 100)),
                    fromDocument: ("rIdChart45",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart46.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 160, 150)),
                    fromDocument: ("rIdChart46",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2401, relationshipId: "rIdChart") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p110 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2402, relationshipId: "rIdChart2") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p150 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2403, relationshipId: "rIdChart3") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p190 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2404, relationshipId: "rIdChart4") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p90 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2405, relationshipId: "rIdChart5") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p140 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2406, relationshipId: "rIdChart6") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p160 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2407, relationshipId: "rIdChart7") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2408, relationshipId: "rIdChart8") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p220 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2409, relationshipId: "rIdChart9") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2410, relationshipId: "rIdChart10") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>45/20 p140 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2411, relationshipId: "rIdChart11") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>45/20 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2412, relationshipId: "rIdChart12") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>45/20 p220 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2413, relationshipId: "rIdChart13") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>45/20 p200 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2414, relationshipId: "rIdChart14") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>22/20 p100 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2415, relationshipId: "rIdChart15") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>22/20 p140 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2416, relationshipId: "rIdChart16") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>22/20 p160 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2417, relationshipId: "rIdChart17") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>22/20 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2418, relationshipId: "rIdChart18") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>22/20 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2419, relationshipId: "rIdChart19") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>38/20 p100 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2420, relationshipId: "rIdChart20") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>38/20 p120 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2421, relationshipId: "rIdChart21") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>38/20 p160 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2422, relationshipId: "rIdChart22") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>38/20 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2423, relationshipId: "rIdChart23") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>38/20 p200 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2424, relationshipId: "rIdChart24") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>38/20 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2425, relationshipId: "rIdChart25") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/35 p100 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2426, relationshipId: "rIdChart26") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/35 p140 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2427, relationshipId: "rIdChart27") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/35 p160 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2428, relationshipId: "rIdChart28") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/35 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2429, relationshipId: "rIdChart29") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/35 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2430, relationshipId: "rIdChart30") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/50 p120 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2431, relationshipId: "rIdChart31") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/50 p140 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2432, relationshipId: "rIdChart32") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/50 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2433, relationshipId: "rIdChart33") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/50 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2434, relationshipId: "rIdChart34") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>60/15 p120 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2435, relationshipId: "rIdChart35") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>60/15 p160 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2436, relationshipId: "rIdChart36") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>60/15 p200 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2437, relationshipId: "rIdChart37") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>60/15 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2438, relationshipId: "rIdChart38") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>45/45 p160 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2439, relationshipId: "rIdChart39") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>45/45 p200 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2440, relationshipId: "rIdChart40") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>45/45 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2441, relationshipId: "rIdChart41") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p160 d50 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2442, relationshipId: "rIdChart42") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p160 d150 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2443, relationshipId: "rIdChart43") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/20 p160 d200 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2444, relationshipId: "rIdChart44") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p160 d100 h50</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2445, relationshipId: "rIdChart45") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p160 d100 h100</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2446, relationshipId: "rIdChart46") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p160 d100 h150</w:t></w:r></w:p>"),

            ["chart-3d-deep2-probe"] = () => new DocxBuilder()
                .WithChart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 200, 0))
                .WithPart("word/charts/chart2.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 220, 0)),
                    fromDocument: ("rIdChart2",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart3.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 25, 20, 120, 0)),
                    fromDocument: ("rIdChart3",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart4.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 25, 20, 180, 0)),
                    fromDocument: ("rIdChart4",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart5.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 25, 20, 240, 0)),
                    fromDocument: ("rIdChart5",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart6.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 33, 20, 120, 0)),
                    fromDocument: ("rIdChart6",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart7.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 33, 20, 180, 0)),
                    fromDocument: ("rIdChart7",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart8.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 33, 20, 240, 0)),
                    fromDocument: ("rIdChart8",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart9.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 50, 15, 20, 160, 0)),
                    fromDocument: ("rIdChart9",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart10.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 20, 160, 0)),
                    fromDocument: ("rIdChart10",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart11.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 200, 15, 20, 160, 0)),
                    fromDocument: ("rIdChart11",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2401, relationshipId: "rIdChart") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p200 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2402, relationshipId: "rIdChart2") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p220 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2403, relationshipId: "rIdChart3") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>25/20 p120 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2404, relationshipId: "rIdChart4") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>25/20 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2405, relationshipId: "rIdChart5") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>25/20 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2406, relationshipId: "rIdChart6") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>33/20 p120 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2407, relationshipId: "rIdChart7") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>33/20 p180 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2408, relationshipId: "rIdChart8") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>33/20 p240 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2409, relationshipId: "rIdChart9") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p160 d50 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2410, relationshipId: "rIdChart10") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p160 d100 h0</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2411, relationshipId: "rIdChart11") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/20 p160 d200 h0</w:t></w:r></w:p>"),

            ["chart-3d-mirror-probe"] = () => new DocxBuilder()
                .WithChart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 45, 80, 0))
                .WithPart("word/charts/chart2.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 30, 45, 80, 0)),
                    fromDocument: ("rIdChart2",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart3.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 40, 80, 0)),
                    fromDocument: ("rIdChart3",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart4.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 50, 80, 0)),
                    fromDocument: ("rIdChart4",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart5.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 35, 80, 0)),
                    fromDocument: ("rIdChart5",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart6.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 55, 80, 0)),
                    fromDocument: ("rIdChart6",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart7.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 30, 80, 0)),
                    fromDocument: ("rIdChart7",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart8.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 60, 80, 0)),
                    fromDocument: ("rIdChart8",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .WithPart("word/charts/chart9.xml",
                    "application/vnd.openxmlformats-officedocument.drawingml.chart+xml",
                    ChartPart(ChartPart3DCounts(1, 1, 0.2, 0.1, 0.6, 0.55, 0, 60, 100, 15, 45, 30, 0)),
                    fromDocument: ("rIdChart9",
                        "http://schemas.openxmlformats.org/officeDocument/2006/relationships/chart"))
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2401, relationshipId: "rIdChart") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/45 self</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2402, relationshipId: "rIdChart2") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>30/45 self</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2403, relationshipId: "rIdChart3") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/40</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2404, relationshipId: "rIdChart4") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/50 mirror of 40</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2405, relationshipId: "rIdChart5") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/35</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2406, relationshipId: "rIdChart6") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/55 mirror of 35</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2407, relationshipId: "rIdChart7") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/30</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2408, relationshipId: "rIdChart8") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/60 mirror of 30</w:t></w:r></w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacingNewPage}</w:pPr>" +
                                 DocxBuilder.ChartDrawing(360, 216, id: 2409, relationshipId: "rIdChart9") +
                                 "</w:p>")
                .AddRawParagraph($"<w:p><w:pPr>{ZeroSpacing}</w:pPr>" +
                                 "<w:r><w:t>15/45 self frustum</w:t></w:r></w:p>"),
