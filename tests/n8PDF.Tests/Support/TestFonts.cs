...
public static class TestFonts
{
    ...
    [
        ...
        "chart-drop-line-probe", "chart-error-bar-probe", "chart-placement-probe", "chart-legend-key-probe",
        "chart-3d-geometry-probe", "chart-3d-height-probe", "chart-3d-gridline-probe", "chart-3d-size-probe",
        "chart-3d-condition-probe", "chart-3d-footprint-probe", "chart-3d-count-probe", "chart-3d-slot-probe",
        "chart-3d-height-count-probe", "chart-3d-depth-probe", "chart-3d-rotation-probe", "chart-3d-projection-probe",
        "chart-3d-wall-probe", "chart-3d-depth-axis-probe", "chart-3d-box-probe", "chart-3d-pie-probe",
        "chart-3d-pie-two-probe",
        ...
        "chart-3d-deep2-probe", "chart-3d-mirror-probe", "hangul-jamo-probe", "shape-rotation-probe",
        "shape-fill-probe", "shape-autofit-probe",
        ...
        "cell-direction-probe", "adjacent-tables-probe", "checkbox-probe", "chart-column", "chart-layout-probe",
        "chart-line-pie", "chart-scale-probe",
        "chart-title-legend-label", "column-order-probe", "columns-uneven", "content-controls",
