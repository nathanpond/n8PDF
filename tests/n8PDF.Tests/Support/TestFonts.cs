...
public static class TestFonts
{
    ...
    [
        ...
        "chart-drop-line-probe", "chart-error-bar-probe", "chart-placement-probe", "chart-legend-key-probe", "chart-3d-geometry-probe", "chart-3d-height-probe", "chart-3d-gridline-probe", "chart-3d-size-probe", "chart-3d-condition-probe", "chart-3d-footprint-probe", "chart-3d-count-probe", "chart-3d-slot-probe", "chart-3d-height-count-probe", "chart-3d-depth-probe", "chart-3d-rotation-probe", "chart-3d-projection-probe", "chart-3d-wall-probe", "chart-3d-depth-axis-probe", "chart-3d-perspective-probe", "chart-3d-camera-probe", "chart-3d-eye-probe", "chart-3d-eye2-probe", "chart-3d-branch-probe", "chart-3d-floor-probe", "chart-3d-inset-probe", "chart-3d-shading-probe", "chart-3d-value-probe",
