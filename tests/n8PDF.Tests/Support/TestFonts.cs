...
public static class TestFonts
{
    ...
    [
        ...
        "chart-drop-line-probe", "chart-error-bar-probe", "chart-placement-probe", "chart-legend-key-probe", "chart-legend-box-probe", "chart-legend-cut-probe", "chart-legend-room-probe", "chart-legend-size-probe", "chart-radar-stock", "chart-title-weight-probe", "chart-trendline-probe", "chart-updown-bar-probe",
        "merged-indent-probe",
