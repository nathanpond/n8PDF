...
privately through the repository's **Security** tab → **Report a vulnerability**, which opens a
private report visible only to the maintainer. (GitHub's private reporting is the confidential channel
this project uses; it is not only for security issues.) All complaints will be reviewed and
