// Vendored from Metalnem/libfuzzer-dotnet @ bd39d4e88d715ab460a929943645be2a186cde52 (MIT).
// The libFuzzer driver SharpFuzz talks to: compiled with `clang -fsanitize=fuzzer` and run as
//   FUZZ_TARGET=<t> libfuzzer-dotnet --target_path=dotnet --target_arg=n8PDF.Fuzz.dll corpus/<t>
// Committed rather than fetched in CI so the fuzzing build is hermetic and pinned (#264).
// Upstream: https://github.com/Metalnem/libfuzzer-dotnet
