...
falling through to the next one — widow and orphan control (two lines of a paragraph on each side of a page or column
...
alignment,
font subsetting, GPOS kerning, tab leaders (the dots that fill the gap in a table of contents),
and the vertical rule a bar tab stop asks for.
